...
| 文件 | 说明 | 工具 |
|------|------|------|
| **[架构图](./logx-architecture.mermaid)** | 模块依赖关系可视化 | Mermaid |
...
| **[init.sql](./init.sql)** | 数据库初始化脚本 | 创建表和测试数据 |
...
### 我是架构师
→ 查看 [架构图](./logx-architecture.mermaid) 和完整的 [项目说明](./LogX-README-v2.md)
